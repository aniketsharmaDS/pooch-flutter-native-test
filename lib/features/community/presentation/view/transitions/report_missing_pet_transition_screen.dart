...
@RoutePage()
class ReportMissingPetTransitionScreen extends StatelessWidget {
  final String petId;

  const ReportMissingPetTransitionScreen({super.key, required this.petId});
  ...
  Widget build(BuildContext context) {
    ...
    return TransitionScreen(
      variant: TransitionScreenVariant.weAreHereWithYou,
