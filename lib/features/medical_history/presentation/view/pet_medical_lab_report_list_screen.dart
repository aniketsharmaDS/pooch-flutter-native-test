...
@RoutePage()
class PetMedicalLabReportListScreen extends StatelessWidget {
  const PetMedicalLabReportListScreen({super.key});

  @override
  Widget build(BuildContext context) => const MedicalHistoryRecordsTabList(
    recordType: MedicalHistoryRecordTypeFilter.labReport,
  );
}
