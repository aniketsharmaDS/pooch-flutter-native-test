...
@RoutePage()
class PetMedicalVaccinationListScreen extends StatelessWidget {
  const PetMedicalVaccinationListScreen({super.key});

  @override
  Widget build(BuildContext context) => const MedicalHistoryRecordsTabList(
    recordType: MedicalHistoryRecordTypeFilter.vaccination,
  );
}
