...
@RoutePage()
class PetMedicalOtherDocumentsListScreen extends StatelessWidget {
  const PetMedicalOtherDocumentsListScreen({super.key});

  @override
  Widget build(BuildContext context) => const MedicalHistoryRecordsTabList(
    recordType: MedicalHistoryRecordTypeFilter.otherDocuments,
  );
}
